...
def load_weights(sess,saver, model_dir):
...
def save_(sess,saver, checkpoint_dir, step):
...
class FCN8s:
    ...
    def train(self,
        ...
        load_weights(self.sess, saver, save_dir)
        ...
        for epoch in range(1, epochs+1):
            ...
            for train_step in tr:
                ...
                for ig in train_generator:
                    
                    batch_images_i, batch_labels_i = next(ig)
                    
                    batch_images.append(batch_images_i)
                    batch_labels.append(batch_labels_i)
            ...
            if save_during_training and (epoch % save_frequency == 0):
                ...
                if save:
                    save_(self.sess, saver, save_dir, epoch)
